...
document.getElementById("footer__copyright-year").innerHTML = `${currentYear}`;

/***/ }),

/***/ "./assets/KickApp/js/chat/alert.js":
/*!*****************************************!*\
  !*** ./assets/KickApp/js/chat/alert.js ***!
  \*****************************************/
...
/***/ "./assets/KickApp/js/chat/kick-account.js":
/*!************************************************!*\
  !*** ./assets/KickApp/js/chat/kick-account.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   awaitAccounts: () => (/* binding */ awaitAccounts),
/* harmony export */   selectAccount: () => (/* binding */ selectAccount),
/* harmony export */   showAccounts: () => (/* binding */ showAccounts),
/* harmony export */   showNoAccounts: () => (/* binding */ showNoAccounts)
/* harmony export */ });
/* harmony import */ var _kick_ws__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./kick-ws */ "./assets/KickApp/js/chat/kick-ws.js");
/* harmony import */ var _alert__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./alert */ "./assets/KickApp/js/chat/alert.js");
...
function awaitAccounts() {
  ...
  setInterval(function () {
    if (_kick_ws__WEBPACK_IMPORTED_MODULE_0__.awaitAccountsPingStatus) {
      _kick_ws__WEBPACK_IMPORTED_MODULE_0__.socket.send(JSON.stringify({
...
/***/ "./assets/KickApp/js/chat/kick-auto-messages-db.js":
/*!*********************************************************!*\
  !*** ./assets/KickApp/js/chat/kick-auto-messages-db.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addAutoMessages: () => (/* binding */ addAutoMessages),
/* harmony export */   clearAllAutoMessages: () => (/* binding */ clearAllAutoMessages),
/* harmony export */   getAutoMessages: () => (/* binding */ getAutoMessages),
/* harmony export */   openAutoMessagesDB: () => (/* binding */ openAutoMessagesDB)
/* harmony export */ });
function openAutoMessagesDB() {
  return new Promise((resolve, reject) => {
    const request = indexedDB.open('kick_auto_messages_db', 1);
...
/***/ "./assets/KickApp/js/chat/kick-auto-messages.js":
/*!******************************************************!*\
  !*** ./assets/KickApp/js/chat/kick-auto-messages.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   intervalSendAutoMessageId: () => (/* binding */ intervalSendAutoMessageId),
/* harmony export */   intervalTimerSendAutoMessageId: () => (/* binding */ intervalTimerSendAutoMessageId),
/* harmony export */   loadAutoMessagesData: () => (/* binding */ loadAutoMessagesData)
/* harmony export */ });
/* harmony import */ var _kick_frequency_db__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./kick-frequency-db */ "./assets/KickApp/js/chat/kick-frequency-db.js");
/* harmony import */ var _kick_auto_messages_db__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./kick-auto-messages-db */ "./assets/KickApp/js/chat/kick-auto-messages-db.js");
/* harmony import */ var _kick_input_logs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./kick-input-logs */ "./assets/KickApp/js/chat/kick-input-logs.js");
/* harmony import */ var _kick_ws__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./kick-ws */ "./assets/KickApp/js/chat/kick-ws.js");
/* harmony import */ var _alert__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./alert */ "./assets/KickApp/js/chat/alert.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
document.getElementById('sendAutoMessageStatus').addEventListener('click', function () {
  ...
  if (workStatus) {
          ...
          if (messages.length) {
            ...
            intervalSendAutoMessageId = setInterval(function () {
              ...
              $.each(selectedAccounts, function (index, value) {
                ...
                ;(0,_kick_input_logs__WEBPACK_IMPORTED_MODULE_2__.addMessageToLogs)(data);
                _kick_ws__WEBPACK_IMPORTED_MODULE_3__.socket.send(JSON.stringify({
            ...
            ;(0,_alert__WEBPACK_IMPORTED_MODULE_4__.showAlert)("You don't have any messages to send automatically", "alert-danger")
          }
        } else {
          $("#sendAutoMessageStatus").prop('checked', false);
          console.log("You don't have any uploaded accounts")
          ;(0,_alert__WEBPACK_IMPORTED_MODULE_4__.showAlert)("You don't have any uploaded accounts", "alert-danger")
          }
      } else {
        $("#sendAutoMessageStatus").prop('checked', false);
        console.log("You have not selected a channel");
        (0,_alert__WEBPACK_IMPORTED_MODULE_4__.showAlert)("You have not selected a channel", "alert-danger")
      }
    } else {
    ...
    $("#sendAutoMessageStatus").prop('checked', false);
    (0,_alert__WEBPACK_IMPORTED_MODULE_4__.showAlert)("You haven't started work. Click on the \"Start work\" button", "alert-danger")
  }
});

function loadAutoMessagesData() {
  (0,_kick_frequency_db__WEBPACK_IMPORTED_MODULE_0__.getFrequency)().then((frequency) => {
    if (frequency) {
  ...
  (0,_kick_auto_messages_db__WEBPACK_IMPORTED_MODULE_1__.getAutoMessages)().then((messages) => {
...
function saveAutoMessages() {
  ...
  let messages = autoMessageTextArea.value.split("\n").map((element) => element.trim()).filter((element) => element !== "");
  if (messages.length) {
    (0,_kick_frequency_db__WEBPACK_IMPORTED_MODULE_0__.addOrUpdateFrequencyDB)(frequencySend.innerText);

    (0,_kick_auto_messages_db__WEBPACK_IMPORTED_MODULE_1__.getAutoMessages)().then((result) => {
      // console.log(result);
    }).catch((error) => {
      console.error('Error:', error);
    });

    (0,_kick_auto_messages_db__WEBPACK_IMPORTED_MODULE_1__.addAutoMessages)(messages).then((result) => {
      (0,_alert__WEBPACK_IMPORTED_MODULE_4__.showAlert)("Messages are saved", "alert-success")
    ...
    (0,_alert__WEBPACK_IMPORTED_MODULE_4__.showAlert)("Are you trying to save an empty field", "alert-danger")
...
/***/ "./assets/KickApp/js/chat/kick-channel-db.js":
/*!***************************************************!*\
  !*** ./assets/KickApp/js/chat/kick-channel-db.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addOrUpdateKickChannelDB: () => (/* binding */ addOrUpdateKickChannelDB),
/* harmony export */   getKickChannel: () => (/* binding */ getKickChannel)
/* harmony export */ });
...
/***/ "./assets/KickApp/js/chat/kick-channel.js":
/*!************************************************!*\
  !*** ./assets/KickApp/js/chat/kick-channel.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   changeViewChannel: () => (/* binding */ changeViewChannel)
/* harmony export */ });
/* harmony import */ var _kick_channel_db__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./kick-channel-db */ "./assets/KickApp/js/chat/kick-channel-db.js");
/* harmony import */ var _alert__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./alert */ "./assets/KickApp/js/chat/alert.js");
/* harmony import */ var _kick_ws__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./kick-ws */ "./assets/KickApp/js/chat/kick-ws.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
async function changeViewChannel(status, channel = undefined) {
    ...
    if (status) {
        ...
        await (0,_kick_channel_db__WEBPACK_IMPORTED_MODULE_0__.addOrUpdateKickChannelDB)(channel);
    } else {
        $("#selectedChannel").removeClass();
...
function changeChannel() {
  ...
  if (inputChannel && inputChannel.trim() !== "") {
    ...
    (0,_kick_channel_db__WEBPACK_IMPORTED_MODULE_0__.addOrUpdateKickChannelDB)(inputChannel);
    changeViewChannel(true, inputChannel);
    (0,_alert__WEBPACK_IMPORTED_MODULE_1__.showAlert)("Channel changed successfully", "alert-success")
    if (window.socket && window.socket.readyState === 1) {
      window.socket.send(JSON.stringify({
        "event": "KICK_SELECT_CHANNEL",
        "message": {"channel": inputChannel}
      }));
    } else if (_kick_ws__WEBPACK_IMPORTED_MODULE_2__.socket && _kick_ws__WEBPACK_IMPORTED_MODULE_2__.socket.readyState === 1) {
      _kick_ws__WEBPACK_IMPORTED_MODULE_2__.socket.send(JSON.stringify({
        "event": "KICK_SELECT_CHANNEL",
        "message": {"channel": inputChannel}
      }));
    } else {
      (0,_alert__WEBPACK_IMPORTED_MODULE_1__.showAlert)("WebSocket is not connected!", "alert-danger");
    }
  } else {
    (0,_alert__WEBPACK_IMPORTED_MODULE_1__.showAlert)("Are you trying to save an empty channel", "alert-danger")
  }
}
...
/***/ "./assets/KickApp/js/chat/kick-frequency-db.js":
/*!*****************************************************!*\
  !*** ./assets/KickApp/js/chat/kick-frequency-db.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addOrUpdateFrequencyDB: () => (/* binding */ addOrUpdateFrequencyDB),
...
/***/ "./assets/KickApp/js/chat/kick-input-logs.js":
/*!***************************************************!*\
  !*** ./assets/KickApp/js/chat/kick-input-logs.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addMessageToLogs: () => (/* binding */ addMessageToLogs)
/* harmony export */ });
...
/***/ "./assets/KickApp/js/chat/kick-range-slider.js":
/*!*****************************************************!*\
  !*** ./assets/KickApp/js/chat/kick-range-slider.js ***!
  \*****************************************************/
...
/***/ "./assets/KickApp/js/chat/kick-send.js":
/*!*********************************************!*\
  !*** ./assets/KickApp/js/chat/kick-send.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   averageSendingPerMinuteId: () => (/* binding */ averageSendingPerMinuteId),
/* harmony export */   countingSendingPerMinute: () => (/* binding */ countingSendingPerMinute)
/* harmony export */ });
/* harmony import */ var _alert__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./alert */ "./assets/KickApp/js/chat/alert.js");
/* harmony import */ var _kick_input_logs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./kick-input-logs */ "./assets/KickApp/js/chat/kick-input-logs.js");
/* harmony import */ var _kick_account__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./kick-account */ "./assets/KickApp/js/chat/kick-account.js");
/* harmony import */ var _kick_ws__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./kick-ws */ "./assets/KickApp/js/chat/kick-ws.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
function kickSend() {
  ...
  if (data) {
    ...
    if(_kick_ws__WEBPACK_IMPORTED_MODULE_3__.workStatus) {
      messagesSent++;
      (0,_kick_input_logs__WEBPACK_IMPORTED_MODULE_1__.addMessageToLogs)(data)
      _kick_ws__WEBPACK_IMPORTED_MODULE_3__.socket.send(JSON.stringify({
        "event": "KICK_SEND_MESSAGE",
        "message": data,
      }));
      ...
      (0,_kick_account__WEBPACK_IMPORTED_MODULE_2__.selectAccount)(document.querySelectorAll('[data-account-selected="true"]')[currentIndex].id);
      inputMessageElement.value = "";
    }
    else {
      (0,_alert__WEBPACK_IMPORTED_MODULE_0__.showAlert)("You haven't started work. Click on the \"Start work\" button", "alert-danger")
    }
  }
}
...
function checkInputMessage(){
  ...
  (0,_alert__WEBPACK_IMPORTED_MODULE_0__.showAlert)("You are trying to send an empty message!", "alert-danger")
  return false
}
...
function checkSelectedChannel() {
  ...
  (0,_alert__WEBPACK_IMPORTED_MODULE_0__.showAlert)("You have not selected a channel!", "alert-danger")
  return false
}
...
function checkSelectedAccount() {
  ...
  (0,_alert__WEBPACK_IMPORTED_MODULE_0__.showAlert)("You have not selected any account!", "alert-danger")
  return false
}
...
/***/ "./assets/KickApp/js/chat/kick-work.js":
/*!*********************************************!*\
  !*** ./assets/KickApp/js/chat/kick-work.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   workTimer: () => (/* binding */ workTimer),
/* harmony export */   workTimerId: () => (/* binding */ workTimerId)
/* harmony export */ });
/* harmony import */ var _kick_ws__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./kick-ws */ "./assets/KickApp/js/chat/kick-ws.js");
/* harmony import */ var _alert__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./alert */ "./assets/KickApp/js/chat/alert.js");
...
function workTimer(startTime) {
  ...
  workTimerId = setInterval(function () {
    if (_kick_ws__WEBPACK_IMPORTED_MODULE_0__.workStatus) {
      let nowTime = new Date();
...
/***/ "./assets/KickApp/js/chat/kick-ws.js":
/*!*******************************************!*\
  !*** ./assets/KickApp/js/chat/kick-ws.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   awaitAccountsPingStatus: () => (/* binding */ awaitAccountsPingStatus),
/* harmony export */   connect: () => (/* binding */ connect),
/* harmony export */   socket: () => (/* binding */ socket),
/* harmony export */   workStatus: () => (/* binding */ workStatus)
/* harmony export */ });
/* harmony import */ var _kick_account__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./kick-account */ "./assets/KickApp/js/chat/kick-account.js");
/* harmony import */ var _alert__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./alert */ "./assets/KickApp/js/chat/alert.js");
/* harmony import */ var _kick_work__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./kick-work */ "./assets/KickApp/js/chat/kick-work.js");
/* harmony import */ var _kick_send__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./kick-send */ "./assets/KickApp/js/chat/kick-send.js");
/* harmony import */ var _kick_auto_messages__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./kick-auto-messages */ "./assets/KickApp/js/chat/kick-auto-messages.js");
    ...
    switch (event) {
      ...
      case 'KICK_CHANNEL_INFO':
        if (message) {
          ...
          (0,_alert__WEBPACK_IMPORTED_MODULE_1__.showAlert)(`Channel loaded: ${message.username || message.slug || ''}`, "alert-success");
        } else if (data.error) {
          (0,_alert__WEBPACK_IMPORTED_MODULE_1__.showAlert)(`Channel error: ${data.error}`, "alert-danger");
        }
        break;
      case 'KICK_LOAD_ACCOUNTS':
        (0,_kick_account__WEBPACK_IMPORTED_MODULE_0__.showAccounts)(message);
        awaitAccountsPingStatus = false;
        break;
      case 'KICK_AWAIT_ACCOUNTS':
        awaitAccountsPingStatus = true;
        (0,_kick_account__WEBPACK_IMPORTED_MODULE_0__.awaitAccounts)();
        break;
      case 'KICK_STOP_AWAIT_ACCOUNTS':
        awaitAccountsPingStatus = false;
        (0,_kick_account__WEBPACK_IMPORTED_MODULE_0__.showNoAccounts)();
        break;
      case 'KICK_SHOW_ERROR':
        (0,_alert__WEBPACK_IMPORTED_MODULE_1__.showAlert)(message, "alert-danger")
        break;
      case 'KICK_START_WORK':
        workStatus = true;
        (0,_kick_send__WEBPACK_IMPORTED_MODULE_3__.countingSendingPerMinute)(message);
        (0,_alert__WEBPACK_IMPORTED_MODULE_1__.showAlert)("You have started work", "alert-success")
        document.getElementById("buttonStartWork").disabled = true
        document.getElementById("buttonEndWork").disabled = false
        ;(0,_kick_work__WEBPACK_IMPORTED_MODULE_2__.workTimer)(message["startWorkTime"])
        break;
      case 'KICK_END_WORK':
        workStatus = false;
        (0,_alert__WEBPACK_IMPORTED_MODULE_1__.showAlert)("Have you finished your work", "alert-success")
        clearInterval(_kick_work__WEBPACK_IMPORTED_MODULE_2__.workTimerId);
        clearInterval(_kick_send__WEBPACK_IMPORTED_MODULE_3__.averageSendingPerMinuteId);
        
        // Stop auto messages if running
        if (_kick_auto_messages__WEBPACK_IMPORTED_MODULE_4__.intervalSendAutoMessageId) {
          clearInterval(_kick_auto_messages__WEBPACK_IMPORTED_MODULE_4__.intervalSendAutoMessageId);
        }
        if (_kick_auto_messages__WEBPACK_IMPORTED_MODULE_4__.intervalTimerSendAutoMessageId) {
          clearInterval(_kick_auto_messages__WEBPACK_IMPORTED_MODULE_4__.intervalTimerSendAutoMessageId);
        }
...
/***/ "./assets/KickApp/js/chat/on-load.js":
/*!*******************************************!*\
  !*** ./assets/KickApp/js/chat/on-load.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _kick_channel_db__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./kick-channel-db */ "./assets/KickApp/js/chat/kick-channel-db.js");
/* harmony import */ var _kick_channel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./kick-channel */ "./assets/KickApp/js/chat/kick-channel.js");
/* harmony import */ var _kick_auto_messages__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./kick-auto-messages */ "./assets/KickApp/js/chat/kick-auto-messages.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  ;(0,_kick_channel_db__WEBPACK_IMPORTED_MODULE_0__.getKickChannel)().then((channel) => {
    if (channel) {
      (0,_kick_channel__WEBPACK_IMPORTED_MODULE_1__.changeViewChannel)(true, channel.value);
    } else {
      (0,_kick_channel__WEBPACK_IMPORTED_MODULE_1__.changeViewChannel)(false);
    }
    }).catch((error) => {
    console.error('Error:', error);
  });
  ...
  ;(0,_kick_auto_messages__WEBPACK_IMPORTED_MODULE_2__.loadAutoMessagesData)()
...
/***/ "./assets/KickApp/js/stats/alert.js":
/*!******************************************!*\
  !*** ./assets/KickApp/js/stats/alert.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./assets/KickApp/js/stats/kick-stat-range-slider.js":
/*!***********************************************************!*\
  !*** ./assets/KickApp/js/stats/kick-stat-range-slider.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./assets/KickApp/js/stats/kick-stats-ws.js":
/*!**************************************************!*\
  !*** ./assets/KickApp/js/stats/kick-stats-ws.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   socket: () => (/* binding */ socket)
/* harmony export */ });
/* harmony import */ var _show__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./show */ "./assets/KickApp/js/stats/show.js");
...
let endpoint = wsStart + loc.host + '/ws-kick/stats';
const socket = new WebSocket(endpoint);
...
function connect() {
  ...
  socket.onmessage = function (e) {
    ...
    switch (event) {
      case 'KICK':
        break;
      case 'KICK_STATS_SHOW':
        console.log("SHOW STATS")
        ;(0,_show__WEBPACK_IMPORTED_MODULE_0__.showStats)(message)
        break;
      default:
        console.log("No event")
    }
...
/***/ "./assets/KickApp/js/stats/on-load.js":
/*!********************************************!*\
  !*** ./assets/KickApp/js/stats/on-load.js ***!
  \********************************************/
/***/ (() => {
...
/***/ "./assets/KickApp/js/stats/show.js":
/*!*****************************************!*\
  !*** ./assets/KickApp/js/stats/show.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _kick_stats_ws__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./kick-stats-ws */ "./assets/KickApp/js/stats/kick-stats-ws.js");
/* harmony import */ var _alert__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./alert */ "./assets/KickApp/js/stats/alert.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
document.getElementById('showMyStat').addEventListener('click', function () {
  ...
  _kick_stats_ws__WEBPACK_IMPORTED_MODULE_1__.socket.send(JSON.stringify({
...
if (sendShowUserStat) {
  document.getElementById('sendShowUserStat').addEventListener('click', function () {
    ...
    if (inputShowUserStatValue && inputShowUserStatValue.trim() !== "") {
      ...
      (0,_alert__WEBPACK_IMPORTED_MODULE_2__.showAlert)("Enter the username for the request", "alert-danger")
    }
  });
}
...
function showStats(data) {
  ...
  if (data.status.code === "success" && data.stat.length) {
    ...
    (0,_alert__WEBPACK_IMPORTED_MODULE_2__.showAlert)(data.status.text, "alert-danger")
  }
...
function drawStatChart(data, canvas){
  ...
  const myChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](ctx, {
    type: 'line',
    data: {
        labels: labels,
...
/***/ "./assets/KickApp/js/stats/stats.js":
/*!******************************************!*\
  !*** ./assets/KickApp/js/stats/stats.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _kick_stats_ws__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./kick-stats-ws */ "./assets/KickApp/js/stats/kick-stats-ws.js");
/* harmony import */ var _kick_stat_range_slider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./kick-stat-range-slider */ "./assets/KickApp/js/stats/kick-stat-range-slider.js");
/* harmony import */ var _kick_stat_range_slider__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_kick_stat_range_slider__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _on_load__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./on-load */ "./assets/KickApp/js/stats/on-load.js");
/* harmony import */ var _on_load__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_on_load__WEBPACK_IMPORTED_MODULE_2__);



(0,_kick_stats_ws__WEBPACK_IMPORTED_MODULE_0__.connect)()

/***/ }),

/***/ "./assets/css/channel-modal.css":
/*!**************************************!*\
  !*** ./assets/css/channel-modal.css ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _css_login_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../css/login.css */ "./assets/css/login.css");
/* harmony import */ var _css_chat_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../css/chat.css */ "./assets/css/chat.css");
/* harmony import */ var _css_stat_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../css/stat.css */ "./assets/css/stat.css");
/* harmony import */ var _css_channel_modal_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../css/channel-modal.css */ "./assets/css/channel-modal.css");
/* harmony import */ var _KickApp_js_chat_on_load__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../KickApp/js/chat/on-load */ "./assets/KickApp/js/chat/on-load.js");
/* harmony import */ var _KickApp_js_chat_kick_ws__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../KickApp/js/chat/kick-ws */ "./assets/KickApp/js/chat/kick-ws.js");
/* harmony import */ var _KickApp_js_chat_kick_send__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../KickApp/js/chat/kick-send */ "./assets/KickApp/js/chat/kick-send.js");
/* harmony import */ var _KickApp_js_chat_kick_channel__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../KickApp/js/chat/kick-channel */ "./assets/KickApp/js/chat/kick-channel.js");
/* harmony import */ var _KickApp_js_chat_kick_account__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../KickApp/js/chat/kick-account */ "./assets/KickApp/js/chat/kick-account.js");
/* harmony import */ var _KickApp_js_chat_kick_range_slider__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../KickApp/js/chat/kick-range-slider */ "./assets/KickApp/js/chat/kick-range-slider.js");
/* harmony import */ var _KickApp_js_chat_kick_range_slider__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_KickApp_js_chat_kick_range_slider__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _KickApp_js_chat_kick_auto_messages__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../KickApp/js/chat/kick-auto-messages */ "./assets/KickApp/js/chat/kick-auto-messages.js");
/* harmony import */ var _KickApp_js_chat_kick_work__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../KickApp/js/chat/kick-work */ "./assets/KickApp/js/chat/kick-work.js");
/* harmony import */ var _KickApp_js_stats_stats_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../KickApp/js/stats/stats.js */ "./assets/KickApp/js/stats/stats.js");
/* harmony import */ var _Django_js_footer__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../Django/js/footer */ "./assets/Django/js/footer.js");
/* harmony import */ var _Django_js_footer__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_Django_js_footer__WEBPACK_IMPORTED_MODULE_16__);
/* provided dependency */ var __webpack_provided_window_dot_jQuery = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
// Import JQuery
